...
<div class="container">
  <div class="row">
    <div class="col-6 p-2 mb-2 bg-primary text-white rounded" style="margin-right: 10px">
    	<div class="row">	
   ...
   <div class="col-sm p-2 mb-2 bg-info text-white rounded">
     <div class="row">	
   ...
   <div class="row">
    <div class="col-sm p-2 mb-2 bg-danger text-white rounded" style="margin-right: 10px"; > <div class="row">	
   ...
   <div class="col-sm p-2 mb-2 bg-success text-white rounded">
     <div class="row">	
  ...
  <div class="row">
    <div class="col-sm p-2 mb-2 bg-warning text-white rounded" style="margin-right: 10px"; > <div class="row">	
   ...
   <div class="col-sm p-2 mb-2 bg-dark text-white rounded">
     <div class="row">	
